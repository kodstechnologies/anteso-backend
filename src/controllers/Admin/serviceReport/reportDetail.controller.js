    ...
    try {
        ...
        res.status(200).json({
            ...
            data: {
                ...
                AccuracyOfOperatingPotentialAndTimeDentalIntra: report.AccuracyOfOperatingPotentialAndTimeDentalIntra,
                LinearityOfTimeDentalIntra: report.LinearityOfTimeDentalIntra,
                ReproducibilityOfRadiationOutputDentalIntra: report.ReproducibilityOfRadiationOutputDentalIntra,
                TubeHousingLeakageDentalIntra: report.TubeHousingLeakageDentalIntra,
            },
        });
    } catch (error) {
...
export default { getCustomerDetails, getTools, getReportHeader, getReportHeaderCBCT, getReportHeaderOPG, getReportHeaderDentalIntra, saveReportHeader }