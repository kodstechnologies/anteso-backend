// controllers/Admin/serviceReport/OPG/LinearityOfmALoading.controller.js
import mongoose from "mongoose";
import LinearityOfmALoading from "../../../../models/testTables/OPG/LinearityOfmALoading.model.js";
...
const create = asyncHandler(async (req, res) => {
  ...
  try {
    ...
    if (existing) {
      ...
      if (toleranceOperator !== undefined) existing.toleranceOperator = toleranceOperator;
      if (measHeaders !== undefined) existing.measHeaders = measHeaders;
      testRecord = existing;
    } else {
      // Create new
      testRecord = new LinearityOfmALoading({
        ...
        measHeaders: measHeaders || ["Measured mR 1", "Measured mR 2", "Measured mR 3"],
      });
    }
    ...
    serviceReport.LinearityOfMaLoadingOPG = testRecord._id;
    await serviceReport.save({ session });
