// controllers/Admin/serviceReport/OPG/RadiationLeakagelevel.controller.js
import mongoose from "mongoose";
import RadiationLeakagelevel from "../../../../models/testTables/OPG/RadiationLeakagelevel.model.js";
...
const create = asyncHandler(async (req, res) => {
  ...
  try {
    ...
    serviceReport.RadiationLeakageTestOPG = testRecord._id;
    await serviceReport.save({ session });
