// controllers/Admin/serviceReport/OPG/RadiationProtectionSurvey.controller.js
import mongoose from "mongoose";
import RadiationProtectionSurvey from "../../../../models/testTables/OPG/RadiationProtectionSurvey.model.js";
...
const create = asyncHandler(async (req, res) => {
  ...
  try {
    ...
    serviceReport.RadiationProtectionSurveyOPG = testRecord._id;
    await serviceReport.save({ session });
