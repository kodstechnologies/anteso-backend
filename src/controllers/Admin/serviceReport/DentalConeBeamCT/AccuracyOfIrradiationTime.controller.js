// controllers/Admin/serviceReport/DentalConeBeamCT/AccuracyOfIrradiationTime.controller.js
import mongoose from "mongoose";
import AccuracyOfIrradiationTime from "../../../../models/testTables/DentalConeBeamCT/AccuracyOfIrradiationTime.model.js";
...
const create = asyncHandler(async (req, res) => {
  ...
  try {
    ...
    if (testRecord) {
      // Update existing
      testRecord.testConditions = testConditions || testRecord.testConditions;
      testRecord.irradiationTimes = irradiationTimes || testRecord.irradiationTimes;
    ...
    serviceReport.AccuracyOfIrradiationTimeCBCT = testRecord._id;
    await serviceReport.save({ session });
