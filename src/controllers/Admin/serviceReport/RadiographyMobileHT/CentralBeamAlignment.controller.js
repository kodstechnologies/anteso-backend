// controllers/Admin/serviceReport/RadiographyMobileHT/CentralBeamAlignment.controller.js
import mongoose from "mongoose";
import CentralBeamAlignment from "../../../../models/testTables/RadiographyMobileHT/CentralBeamAlignment.model.js";
...
const create = asyncHandler(async (req, res) => {
  ...
  try {
    ...
    serviceReport.CentralBeamAlignmentRadiographyMobileHT = testRecord._id;
    await serviceReport.save({ session });
