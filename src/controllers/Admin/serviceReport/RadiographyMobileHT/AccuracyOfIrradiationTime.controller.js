// controllers/Admin/serviceReport/RadiographyMobileHT/AccuracyOfIrradiationTime.controller.js
import mongoose from "mongoose";
import AccuracyOfIrradiationTime from "../../../../models/testTables/RadiographyMobileHT/AccuracyOfIrradiationTime.model.js";
...
const create = asyncHandler(async (req, res) => {
  ...
  try {
    ...
    serviceReport.AccuracyOfIrradiationTimeRadiographyMobileHT = testRecord._id;
    await serviceReport.save({ session });
