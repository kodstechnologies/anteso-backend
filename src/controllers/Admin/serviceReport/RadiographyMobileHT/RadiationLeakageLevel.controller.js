// controllers/Admin/serviceReport/RadiographyMobileHT/RadiationLeakageLevel.controller.js
import mongoose from "mongoose";
import RadiationLeakageLevel from "../../../../models/testTables/RadiographyMobileHT/RadiationLeakageLevel.model.js";
...
const create = asyncHandler(async (req, res) => {
  ...
  try {
    ...
    serviceReport.RadiationLeakageLevelRadiographyMobileHT = testRecord._id;
    await serviceReport.save({ session });
