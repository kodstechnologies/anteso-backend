// controllers/Admin/serviceReport/RadiographyMobileHT/Congruence.controller.js
import mongoose from "mongoose";
import Congruence from "../../../../models/testTables/RadiographyMobileHT/congruence.model.js";
...
const create = asyncHandler(async (req, res) => {
  ...
  try {
    ...
    serviceReport.CongruenceOfRadiationRadiographyMobileHT = testRecord._id;
    await serviceReport.save({ session });
