// controllers/Admin/serviceReport/RadiographyMobileHT/LinearityOfMasLoadingStations.controller.js
import mongoose from "mongoose";
import LinearityOfMasLoadingStations from "../../../../models/testTables/RadiographyMobileHT/LinearityOfMasLoadingStations.model.js";
...
const create = asyncHandler(async (req, res) => {
  ...
  try {
    ...
    serviceReport.LinearityOfmAsLoadingRadiographyMobileHT = testRecord._id;
    await serviceReport.save({ session });
