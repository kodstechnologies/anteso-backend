// controllers/Admin/serviceReport/RadiographyMobileHT/RadiationProtectionSurvey.controller.js
import mongoose from "mongoose";
import RadiationProtectionSurvey from "../../../../models/testTables/RadiographyMobileHT/RadiationProtectionSurvey.model.js";
...
const create = asyncHandler(async (req, res) => {
  ...
  try {
    ...
    serviceReport.RadiationProtectionSurveyRadiographyMobileHT = testRecord._id;
    await serviceReport.save({ session });
