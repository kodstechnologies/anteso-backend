// controllers/Admin/serviceReport/BMD/TotalFilteration.controller.js
...
const create = asyncHandler(async (req, res) => {
  ...
  try {
    ...
    serviceReport.TotalFilterationBMD = testRecord._id;
    await serviceReport.save({ session });
    ...
    return res.json({
      success: true,
      message: isNewRecord ? "Test created successfully" : "Test updated successfully",
      data: {
