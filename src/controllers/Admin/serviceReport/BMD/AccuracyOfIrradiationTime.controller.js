// controllers/Admin/serviceReport/BMD/AccuracyOfIrradiationTime.controller.js
import mongoose from "mongoose";
import AccuracyOfIrradiationTime from "../../../../models/testTables/BMD/AccuracyOfIrradiationTime.model.js";
...
const create = asyncHandler(async (req, res) => {
  ...
  try {
    ...
    serviceReport.AccuracyOfIrradiationTimeBMD = testRecord._id;
    await serviceReport.save({ session });
