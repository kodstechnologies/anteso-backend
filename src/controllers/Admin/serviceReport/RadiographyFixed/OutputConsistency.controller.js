// controllers/Admin/serviceReport/RadiographyFixed/OutputConsistency.controller.js
import mongoose from "mongoose";
import OutputConsistency from "../../../../models/testTables/RadiographyFixed/OutputConsistency.model.js";
...
const create = asyncHandler(async (req, res) => {
  ...
  try {
    ...
    serviceReport.ConsistencyOfRadiationOutputFixedRadiography = testRecord._id;
    await serviceReport.save({ session });
