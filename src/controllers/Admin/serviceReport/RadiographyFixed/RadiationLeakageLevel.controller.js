// controllers/Admin/serviceReport/RadiographyFixed/RadiationLeakageLevel.controller.js
import mongoose from "mongoose";
import RadiationLeakageLevel from "../../../../models/testTables/RadiographyFixed/RadiationLeakageLevel.model.js";
...
const create = asyncHandler(async (req, res) => {
  ...
  try {
    ...
    serviceReport.RadiationLeakageLevelRadiographyFixed = testRecord._id;
    await serviceReport.save({ session });
