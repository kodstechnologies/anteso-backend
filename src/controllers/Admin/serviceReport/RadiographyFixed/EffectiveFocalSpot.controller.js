// controllers/Admin/serviceReport/RadiographyFixed/EffectiveFocalSpot.controller.js
import mongoose from "mongoose";
import EffectiveFocalSpot from "../../../../models/testTables/RadiographyFixed/EffectiveFocalSpot.model.js";
...
const normalizeFocalSpots = (spots) => {
  ...
  return spots.map((spot = {}) => {
    ...
    return {
      ...
      // Keep legacy fields aligned with nominal for old templates/views.
...
const create = asyncHandler(async (req, res) => {
  ...
  try {
    ...
    serviceReport.EffectiveFocalSpotRadiographyFixed = testRecord._id;
    await serviceReport.save({ session });
