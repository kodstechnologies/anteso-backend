// controllers/Admin/serviceReport/CTScan/RadiationProtectionSurvey.controller.js
import mongoose from "mongoose";
import RadiationProtectionSurvey from "../../../../models/testTables/CTScan/RadiationProtectionSurvey.model.js";
...
const create = asyncHandler(async (req, res) => {
  ...
  try {
    ...
    serviceReport.RadiationProtectionSurveyCTScan = testRecord._id;
    await serviceReport.save({ session });
