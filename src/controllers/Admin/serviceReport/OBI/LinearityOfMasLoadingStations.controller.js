// controllers/Admin/serviceReport/OBI/LinearityOfMasLoadingStations.controller.js
import mongoose from "mongoose";
import LinearityOfMasLoadingStations from "../../../../models/testTables/OBI/LinearityOfMasLoadingStations.model.js";
...
const create = asyncHandler(async (req, res) => {
  ...
  try {
    ...
    serviceReport.LinearityOfMasLoadingStationsOBI = testRecord._id;
    await serviceReport.save({ session });
...
const update = asyncHandler(async (req, res) => {
  ...
  try {
    ...
    if (session) await session.abortTransaction();
    console.error("LinearityOfMasLoadingStations Update Error:", error);
    return res.status(500).json({
      success: false,
