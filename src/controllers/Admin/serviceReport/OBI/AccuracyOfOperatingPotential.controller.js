// controllers/Admin/serviceReport/OBI/AccuracyOfOperatingPotential.controller.js
import mongoose from "mongoose";
import AccuracyOfOperatingPotential from "../../../../models/testTables/OBI/AccuracyOfOperatingPotential.model.js";
...
const create = asyncHandler(async (req, res) => {
  ...
  try {
    ...
    serviceReport.accuracyOfOperatingPotentialOBI = testRecord._id;
    await serviceReport.save({ session });
