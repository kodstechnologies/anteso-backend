// controllers/Admin/serviceReport/OBI/OutputConsistency.controller.js
import mongoose from "mongoose";
import OutputConsistency from "../../../../models/testTables/OBI/OutputConsistency.model.js";
...
const create = asyncHandler(async (req, res) => {
  ...
  try {
    ...
    serviceReport.OutputConsistencyOBI = testRecord._id;
    await serviceReport.save({ session });
