// controllers/Admin/serviceReport/OBI/EffectiveFocalSpot.controller.js
import mongoose from "mongoose";
import EffectiveFocalSpot from "../../../../models/testTables/OBI/EffectiveFocalSpot.model.js";
...
const create = asyncHandler(async (req, res) => {
  ...
  try {
    ...
    serviceReport.EffectiveFocalSpotOBI = testRecord._id;
    await serviceReport.save({ session });
...
const update = asyncHandler(async (req, res) => {
  ...
  try {
    ...
    if (session) await session.abortTransaction();
    console.error("EffectiveFocalSpot Update Error:", error);
    return res.status(500).json({
      success: false,
