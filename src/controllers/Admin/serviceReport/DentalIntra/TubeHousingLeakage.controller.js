// controllers/Admin/serviceReport/DentalIntra/TubeHousingLeakage.controller.js
import mongoose from "mongoose";
import TubeHousingLeakage from "../../../../models/testTables/DentalIntra/TubeHousingLeakage.model.js";
...
const create = asyncHandler(async (req, res) => {
  ...
  try {
    ...
    serviceReport.TubeHousingLeakageDentalIntra = testRecord._id;
    await serviceReport.save({ session });
