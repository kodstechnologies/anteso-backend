// controllers/Admin/serviceReport/Mammography/AccuracyOfIrradiationTime.controller.js
import mongoose from "mongoose";
import AccuracyOfIrradiationTime from "../../../../models/testTables/Mammography/AccuracyOfIrradiationTime.model.js";
...
const create = asyncHandler(async (req, res) => {
  ...
  try {
    ...
    serviceReport.AccuracyOfIrradiationTimeMammography = testRecord._id;
    await serviceReport.save({ session });
