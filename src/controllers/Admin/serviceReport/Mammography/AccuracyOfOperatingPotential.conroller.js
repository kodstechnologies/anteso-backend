...
import AccuracyOfOperatingPotential from "../../../../models/testTables/Mammography/AccuracyOfOperatingPotential.model.js";
...
const create = asyncHandler(async (req, res) => {
    ...
    try {
        ...
        return res.json({
            success: true,
            message: testRecord.wasNew ? "Test created successfully" : "Test updated successfully",
            data: {
...
const getById = asyncHandler(async (req, res) => {
    const { testId } = req.params; // this is testId
