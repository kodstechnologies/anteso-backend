// controllers/Admin/serviceReport/RadiographyPortable/AccuracyOfOperatingPotential.controller.js
import mongoose from "mongoose";
import AccuracyOfOperatingPotential from "../../../../models/testTables/RadiographyPortable/AccuracyOfOperatingPotential.model.js";
...
const create = asyncHandler(async (req, res) => {
  ...
  try {
    ...
    serviceReport.accuracyOfOperatingPotentialRadigraphyPortable = testRecord._id;
    await serviceReport.save({ session });
