// controllers/Admin/serviceReport/RadiographyPortable/CentralBeamAlignment.controller.js
import mongoose from "mongoose";
import CentralBeamAlignment from "../../../../models/testTables/RadiographyPortable/CentralBeamAlignment.model.js";
...
const create = asyncHandler(async (req, res) => {
  ...
  try {
    ...
    serviceReport.CentralBeamAlignmentRadiographyPortable = testRecord._id;
    await serviceReport.save({ session });
