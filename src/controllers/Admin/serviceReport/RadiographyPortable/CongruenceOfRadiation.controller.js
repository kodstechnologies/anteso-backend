// controllers/Admin/serviceReport/RadiographyPortable/CongruenceOfRadiation.controller.js
import mongoose from "mongoose";
import CongruenceOfRadiation from "../../../../models/testTables/RadiographyPortable/CongruenceOfRadiation.model.js";
...
const create = asyncHandler(async (req, res) => {
  ...
  try {
    ...
    serviceReport.CongruenceOfRadiationRadioGraphyPortable = testRecord._id;
    await serviceReport.save({ session });
