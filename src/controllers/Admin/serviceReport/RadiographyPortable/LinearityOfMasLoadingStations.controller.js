// controllers/Admin/serviceReport/RadiographyPortable/LinearityOfMasLoadingStations.controller.js
import mongoose from "mongoose";
import LinearityOfMasLoadingStations from "../../../../models/testTables/RadiographyPortable/LinearityOfMasLoadingStations.model.js";
...
const create = asyncHandler(async (req, res) => {
  ...
  try {
    ...
    serviceReport.LinearityOfmAsLoadingRadiographyPortable = testRecord._id;
    await serviceReport.save({ session });
