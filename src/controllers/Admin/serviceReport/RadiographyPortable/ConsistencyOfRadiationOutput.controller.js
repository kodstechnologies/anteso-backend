// controllers/Admin/serviceReport/RadiographyPortable/ConsistencyOfRadiationOutput.controller.js
import mongoose from "mongoose";
import ConsistencyOfRadiationOutput from "../../../../models/testTables/RadiographyPortable/ConsisitencyOfRadiationOutput.model.js";
...
const create = asyncHandler(async (req, res) => {
  ...
  try {
    ...
    serviceReport.ConsistencyOfRadiationOutputRadiographyPortable = testRecord._id;
    await serviceReport.save({ session });
