// controllers/Admin/serviceReport/RadiographyPortable/EffectiveFocalSpot.controller.js
import mongoose from "mongoose";
import EffectiveFocalSpot from "../../../../models/testTables/RadiographyPortable/EffectiveFocalSpot.model.js";
// Note: mongoose is still imported for ObjectId validation
...
const create = asyncHandler(async (req, res) => {
  ...
  try {
    ...
    let testRecord = await EffectiveFocalSpot.findOne({ serviceId });
    ...
    serviceReport.EffectiveFocalSpotRadiographyPortable = testRecord._id;
    await serviceReport.save();
