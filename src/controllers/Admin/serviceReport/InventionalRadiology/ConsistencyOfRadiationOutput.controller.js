...
import ConsistencyOfRadiationOutput from "../../../../models/testTables/InventionalRadiology/ConsistencyOfRadiationOutput.model.js";

const MACHINE_TYPE = "Interventional Radiology";

const create = asyncHandler(async (req, res) => {
    const { fdd, outputRows, measurementHeaders, tolerance, tubeId } = req.body;
    ...
    try {
        ...
        let testRecord = await ConsistencyOfRadiationOutput.findOne({ serviceId, tubeId: tubeIdValue }).session(session);
        ...
        serviceReport.ConsistencyOfRadiationOutputInventionalRadiology = testRecord._id;
        await serviceReport.save({ session });
...
const getById = asyncHandler(async (req, res) => {
    ...
    try {
        const testRecord = await ConsistencyOfRadiationOutput.findById(testId)
            .lean()
            .exec();
...
const update = asyncHandler(async (req, res) => {
    ...
    try {
        ...
        // Update fields
        if (fdd !== undefined) testRecord.fdd = fdd;
...
const getByServiceId = asyncHandler(async (req, res) => {
    ...
    try {
        ...
        const testRecord = await ConsistencyOfRadiationOutput.findOne(query).lean().exec();
