// controllers/Admin/serviceReport/RadiographyMobile/EffectiveFocalSpot.controller.js
import mongoose from "mongoose";
import EffectiveFocalSpot from "../../../../models/testTables/RadiographyMobile/EffectiveFocalSpot.model.js";
...
const create = asyncHandler(async (req, res) => {
  ...
  try {
    ...
    serviceReport.EffectiveFocalSpotRadiographyMobile = testRecord._id;
    await serviceReport.save({ session });
