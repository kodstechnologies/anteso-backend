// controllers/Admin/serviceReport/RadiographyMobile/LinearityOfMasLoadingStations.controller.js
import mongoose from "mongoose";
import LinearityOfMasLoadingStations from "../../../../models/testTables/RadiographyMobile/LinearityOfMasLoadingStations.model.js";
...
const create = asyncHandler(async (req, res) => {
  ...
  try {
    ...
    serviceReport.LinearityOfmAsLoadingRadiographyMobile = testRecord._id;
    await serviceReport.save({ session });
