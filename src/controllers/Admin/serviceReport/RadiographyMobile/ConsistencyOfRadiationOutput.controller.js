// controllers/Admin/serviceReport/RadiographyMobile/ConsistencyOfRadiationOutput.controller.js
import mongoose from "mongoose";
import ConsistencyOfRadiationOutput from "../../../../models/testTables/RadiographyMobile/ConsisitencyOfRadiationOutput.model.js";
...
const create = asyncHandler(async (req, res) => {
  ...
  try {
    ...
    if (testRecord) {
      ...
      testRecord = new ConsistencyOfRadiationOutput({
        serviceId,
    ...
    serviceReport.ConsistencyOfRadiationOutputRadiographyMobile = testRecord._id;
    await serviceReport.save({ session });
...
const getById = asyncHandler(async (req, res) => {
  ...
  try {
    const testRecord = await ConsistencyOfRadiationOutput.findById(testId).lean();
    if (!testRecord) {
...
const getByServiceId = asyncHandler(async (req, res) => {
  ...
  try {
    const testRecord = await ConsistencyOfRadiationOutput.findOne({ serviceId }).lean();
    if (!testRecord) {
