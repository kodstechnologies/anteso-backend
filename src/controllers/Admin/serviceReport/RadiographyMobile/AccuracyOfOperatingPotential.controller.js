// controllers/Admin/serviceReport/RadiographyMobile/AccuracyOfOperatingPotential.controller.js
import mongoose from "mongoose";
import AccuracyOfOperatingPotential from "../../../../models/testTables/RadiographyMobile/AccuracyOfOperatingPotential.model.js";
...
const create = asyncHandler(async (req, res) => {
  ...
  try {
    ...
    serviceReport.accuracyOfOperatingPotentialRadigraphyMobile = testRecord._id;
    await serviceReport.save({ session });
