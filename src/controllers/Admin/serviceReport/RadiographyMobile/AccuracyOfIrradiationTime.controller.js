// controllers/Admin/serviceReport/RadiographyMobile/AccuracyOfIrradiationTime.controller.js
import mongoose from "mongoose";
import AccuracyOfIrradiationTime from "../../../../models/testTables/RadiographyMobile/AccuracyOfIrradiationTime.model.js";
...
const create = asyncHandler(async (req, res) => {
  ...
  try {
    ...
    serviceReport.AccuracyOfIrradiationTimeRadiographyMobile = testRecord._id;
    await serviceReport.save({ session });
