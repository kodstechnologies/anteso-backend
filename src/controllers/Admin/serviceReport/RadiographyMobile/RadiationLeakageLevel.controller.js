// controllers/Admin/serviceReport/RadiographyMobile/RadiationLeakageLevel.controller.js
import mongoose from "mongoose";
import RadiationLeakageLevel from "../../../../models/testTables/RadiographyMobile/RadiationLeakageLevel.model.js";
...
const create = asyncHandler(async (req, res) => {
  ...
  try {
    ...
    serviceReport.RadiationLeakageLevelRadiographyMobile = testRecord._id;
    await serviceReport.save({ session });
