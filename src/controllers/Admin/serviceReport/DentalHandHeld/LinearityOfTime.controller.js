// controllers/Admin/serviceReport/DentalHandHeld/LinearityOfTime.controller.js
import mongoose from "mongoose";
import LinearityOfTime from "../../../../models/testTables/DentalHandHeld/LinearityOfTime.model.js";
...
const create = asyncHandler(async (req, res) => {
  ...
  try {
    ...
    serviceReport.LinearityOfTimeDentalHandHeld = testRecord._id;
    await serviceReport.save({ session });
