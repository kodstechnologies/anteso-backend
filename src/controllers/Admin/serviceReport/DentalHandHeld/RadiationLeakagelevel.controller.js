// controllers/Admin/serviceReport/DentalHandHeld/RadiationLeakagelevel.controller.js
import mongoose from "mongoose";
import RadiationLeakagelevel from "../../../../models/testTables/DentalHandHeld/RadiationLeakagelevel.model.js";
...
const create = asyncHandler(async (req, res) => {
  ...
  try {
    ...
    serviceReport.RadiationLeakageTestDentalHandHeld = testRecord._id;
    await serviceReport.save({ session });
