import RadiationProtectionSurveyModel from '../../../../models/testTables/DentalHandHeld/RadiationProtectionSurvey.model.js';
...
export const addRadiationProtectionSurvey = async (req, res) => {
    try {
        ...
        await serviceReportModel.findOneAndUpdate(
            { serviceId },
            { RadiationProtectionSurveyDentalHandHeld: savedEntry._id }
        );
