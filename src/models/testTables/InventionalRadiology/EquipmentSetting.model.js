...
const EquipmentSettingIRSchema = new mongoose.Schema(
  {
...
// Indexes
EquipmentSettingIRSchema.index({ serviceId: 1 });
EquipmentSettingIRSchema.index({ reportId: 1 });
EquipmentSettingIRSchema.index({ serviceId: 1, reportId: 1 });

export default mongoose.models.EquipmentSettingForInterventionalRadiology ||
  mongoose.model('EquipmentSettingForInterventionalRadiology', EquipmentSettingIRSchema);