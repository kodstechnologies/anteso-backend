...
const ReproducibilityOfOutputSchema = new mongoose.Schema(
    {
        ...
        // Custom measurement column headers (dynamic Meas 1, Meas 2, …)
...
export default mongoose.model('ConsistencyOfRadiationOutputRadiographyPortable', ReproducibilityOfOutputSchema);